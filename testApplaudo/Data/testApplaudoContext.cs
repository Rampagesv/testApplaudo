    ...
    public class testApplaudoContext : IdentityDbContext<IdentityUser> //DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Products>().HasData(
                    new { ProductId = 1, ProductSKU = "B01M7UII5H", ProductName = "Nespresso by De'Longhi ENV135R Coffee and Espresso Machine, Red", ProductPrice = decimal.Parse("118.56"), inStock = 10, ProductLikes = 0 },
                    new { ProductId = 2, ProductSKU = "B018UQ5AMS", ProductName = "Keurig K-Classic Coffee Maker K-Cup Pod, Single Serve, Programmable, Black", ProductPrice = decimal.Parse("79.99"), inStock = 10, ProductLikes = 0 },
                    new { ProductId = 3, ProductSKU = "B07SPW37M3", ProductName = "McCafe Decaf Premium Roast Keurig K Cup Coffee Pods 100 Cups", ProductPrice = decimal.Parse("53.17"), inStock = 10, ProductLikes = 0 }
                    );

            builder.Entity<Stock>().HasData(
                    new { MovementId = 1, ProductID = 1, PurchaseId = 0, MovementTypeid = 1, MovementDate = DateTime.UtcNow, MovementQuantity = 10, ProductQuantity = 10},
                    new { MovementId = 2, ProductID = 2, PurchaseId = 0, MovementTypeid = 1, MovementDate = DateTime.UtcNow, MovementQuantity = 10, ProductQuantity = 10},
                    new { MovementId = 3, ProductID = 3, PurchaseId = 0, MovementTypeid = 1, MovementDate = DateTime.UtcNow, MovementQuantity = 10, ProductQuantity = 10}
                );
